...
def adjustCountry():
    ...
    with open("./bases/suicide/Country_ajustado.csv","rb") as source:
        rdr= csv.reader( source )
        with open("./bases/suicide/Country_ajustadoFix.csv","wb") as result:
            novo_csv = csv.writer( result )
